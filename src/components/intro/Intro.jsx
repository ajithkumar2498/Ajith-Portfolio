...
function Intro() {
 ...
 <section className='intro'>
    ...
    <a><button className="btn"  class="btn btn-danger" onClick={()=>openresume()}><img src={contact_dark} alt="" className="btnImg" />View CV</button></a>
    <a href={resume} target='_blank' download="resume"><button className="btn"   ><img src={download} alt="" className="btnImg" />CV</button></a>
    </div>
    </div>
